...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "farrah", "How can we fail this test", d3);
    private static final Tweet tweet4 = new Tweet(4, "beenish", "@test1 how can you demonstrate this test?",d4);
    private static final Tweet tweet5 = new Tweet(5, "farrah", "@test1 @test2 web is good subject",d5);
    private static final Tweet tweet6 = new Tweet(6, "beenish", "@test1 @test1 SC is a Good Subject",d6);
